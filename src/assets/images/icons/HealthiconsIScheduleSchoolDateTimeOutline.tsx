 ...
 * Create at: 9:51 AM - 17/04/2025
 *  User: kimin
 **/

import type { SVGProps } from "react";

export function HealthiconsIScheduleSchoolDateTimeOutline(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width={48} height={48} viewBox='0 0 48 48' {...props}>
			<g fill='currentColor'>
				...
				<path d='M35 31.5a1 1 0 0 1 1 1v2.086l.707.707a1 1 0 0 1-1.414 1.414L34 35.414V32.5a1 1 0 0 1 1-1'></path>
				<path
					fillRule='evenodd'
					...
					clipRule='evenodd'></path>
				<path d='M27 13a1 1 0 0 1-1-1v-1H16V9h10V7a1 1 0 1 1 2 0v5a1 1 0 0 1-1 1'></path>
			</g>
		</svg>
	);
}
