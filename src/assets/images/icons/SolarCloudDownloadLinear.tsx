 ...
 * Create at: 2:08 PM - 14/05/2025
 *  User: kimin
 **/

import type { SVGProps } from "react";

export function SolarCloudDownloadLinear(props: SVGProps<SVGSVGElement>) {
	return (
		<svg xmlns='http://www.w3.org/2000/svg' width={24} height={24} viewBox='0 0 24 24' {...props}>
			<g fill='none' stroke='currentColor' strokeLinecap='round' strokeWidth={1.5}>
				...
				<path strokeLinejoin='round' d='M12 22v-6m0 6l2-2m-2 2l-2-2'></path>
			</g>
		</svg>
	);
}
