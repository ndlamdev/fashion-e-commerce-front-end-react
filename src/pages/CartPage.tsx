...
import { selectItems, setShowConfirm, setVoucher, unselectItems, updateCartItemSelected } from "@/redux/slice/cart.slice.ts";
...
function CartPage() {
  ...
  const { voucher, showConfirm } = useSelector((state: RootState) => state.cartSlice);
