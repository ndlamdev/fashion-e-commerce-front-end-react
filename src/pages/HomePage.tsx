  ...
  return (
    <main className={"w-full flex flex-col justify-center"}>
      ...
      <section className={"px-5 md:px-10 lg:px-15 py-6 md:py-10 lg:py-14 flex flex-col gap-10"}>
        <Tabs defaultValue={"male"}>
          <TabsList className={"h-auto bg-[none] gap-2 md:gap-4 lg:gap-8 mb-5"}>
            <TabsTrigger
              className={
                "data-[state=active]:bg-black w-32 rounded-4xl text-black font-bold bg-gray-200 data-[state=active]:text-white text-md p-3 data-[state=active]:border-black data-[state=active]:border-b-2 shadow-none"
              }
              value="male">
              ĐỒ NAM
            </TabsTrigger>
          ...
          <TabsContent value={"male"}>
            <div ref={setRef} className={"h-[280px] md:h-[315px] lg:h-[350px] transition-all flex gap-4 overflow-x-scroll scroll-hidden"}>
        ...
        <div className={"flex flex-col lg:flex-row gap-10"}>
          <div id={"main-collection"} className={"flex-1 aspect-[3/2] rounded-3xl overflow-hidden relative group"}>
            <img
              ...
              alt="image.png"
              className={"size absolute top-0 left-0 group-hover:scale-[1.03] duration-200 transition ease-in"}
            />
            <div className={"absolute top-0 left-0 flex flex-col gap-3 justify-end size-full items-start p-5"}>
              ...
              <a href={"#"} className={"uppercase px-8 py-3 bg-white rounded-4xl"}>
                Mua ngay
              </a>
            </div>
          </div>
          <div id={"women-collection"} className={"flex-1 aspect-[3/2] rounded-3xl overflow-hidden relative group"}>
            <img
            ...
            <div className={"absolute top-0 left-0 flex flex-col gap-3 justify-end size-full items-start p-5"}>
              ...
              <a href={"#"} className={"uppercase px-8 py-3 bg-white rounded-4xl font-light"}>
                Mua ngay
              </a>
            </div>
          </div>
      ...
      <section>
        <div
          className={
            "h-[30rem] bg-no-repeat bg-cover w-full flex flex-col items-start justify-end lg:p-14 md:10 p-5 bg-[url('https://media3.coolmate.me/cdn-cgi/image/quality=80,format=auto/uploads/March2025/hang-ngay-desk-chung.jpg')]"
          }>
      ...
      <section>
        <div
          className={
            "h-[30rem] bg-no-repeat bg-cover w-full flex flex-col items-start justify-end lg:p-14 md:10 p-5 bg-[url('https://media3.coolmate.me/cdn-cgi/image/quality=80,format=auto/uploads/March2025/running-desk-chung_23.jpg')]"
          }>
      ...
      <section>
        <a href="#">
          <img
            className={"px-5 md:px-10 lg:px-15 pb-6 md:pb-10 lg:pb-14 flex"}
