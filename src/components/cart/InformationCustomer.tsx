...
function InformationCustomer() {
  ...
  const { setValue, getValues, register, trigger, setError, formState: { errors } } = useForm<InfoCustomerCreateOrder>();
      ...
      <div className={"flex flex-col gap-4"}>
        ...
        <div className={"address"}>
          ...
          <div className={"mt-2 flex w-full flex-col flex-wrap gap-2 lg:flex-row"}>
            <div className={"w-full lg:w-auto lg:grow  py-5"}>
