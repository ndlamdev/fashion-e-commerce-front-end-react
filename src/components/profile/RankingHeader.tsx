	...
	return (
			<div className="md:p-4 flex flex-wrap justify-between items-center bg-neutral-300 md:bg-white md:shadow-lg md:rounded-lg">
				<div className=" p-4 max-md:w-full w-2/3 bg-white max-md:shadow-lg rounded-lg">
					<h2 className="mb-4 text-4xl max-md:text-xl font-bold">Hi, {props.fullName}</h2>
					<LevelClub styleName={"text-lg lg:text-2xl"} styleIcon={"size-5"} level={props.levelClub} />
					<div className="flex items-center space-x-1 mt-4">
						<p className="text-xs md:text-base">Chi tiêu thêm <span
							className="text-xs md:text-base font-bold text-sky-600">{formatCurrency(props.nextRankingValue ?? 0)}</span> để lên
							hạng</p>
					...
					<div className="relative ">
						...
						<p className="text-xs md:text-base text-neutral-400 mt-12 italic">Hạng thành viên được vừa được xét lại vào
					...
					<div className=" p-4 bg-white max-md:w-full  max-md:rounded-lg max-md:shadow-lg ">
						...
						<p
							...
							<HoverCard>
								...
								<HoverCardContent>
									<p className="max-md:text-xs">Đây là số point bạn sẽ nhận được khi nhận các đơn hàng đang chờ thành công</p>
								</HoverCardContent>
							</HoverCard>
						</p>
					</div>
